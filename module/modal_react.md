...
<div class="be-button">
  ...
  NT Modal (React)
  <a class="link" href="https://noistommy.github.io/react-nt-modal" target="_blank" />
</div>
Demo page
...
| --- | --- | --- | --- |
| useStack | *boolean* | `true` | Setting use multiple modal. |
...
<div class="be-button">
  ...
  Github
  <a class="link" href="https://github.com/noistommy/react-nt-modal.git" target="_blank" />
</div>
<div class="be-button">
  <i class="icon left xi-package" />
  npm
  <a class="link" href=" https://www.npmjs.com/package/react-nt-modal" target="_blank" />
</div>
