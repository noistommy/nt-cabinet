...
## 문제
- 디자인시스템 활용을 위해 기존의 스타일과 기능이 결합된 SFC(single file component) 구조에서 스타일을 분리할 필요가 발생
- 또한 기존의 컴포넌트는 프레임워크 의존이 강하기 때문에 다중 프레임워크 개발 환경에서 사용이 어려움
...
## ![frog-ui](/img/frog-profile.svg){width=22} Frog UI
...
## ![be-ui](/img/be-ui-vue.svg){width=22} BEUI (vue) - Headless UI
...
<div class="caption">BEUI document site main</div>
